...
export const Data = {
  create: {
    ...
    error: {
      ...
      403: {
        ...
        redirectUrl: Routes.profile_bio.family.edit,
      },
      422: {
  ...
  edit: {
    ...
    success: {
      ...
      redirectUrl: Routes.profile_bio.url,
      shortToLongRedirect: Routes.profile_bio.profession.edit,
    },
    error: {
...
export const VM = {
  family_members_info: {
    required: "পারিবারিক সদস্যদের তথ্য আবশ্যক।",
    minLength: "পারিবারিক সদস্যদের তথ্য সর্বনিম্ন ১০ অক্ষর হতে হবে।",
    maxLength: "পারিবারিক সদস্যদের তথ্য সর্বাধিক ১৫০০ অক্ষর হতে পারবে।",
  },
  uncles_info: {
    maxLength: "চাচা/মামার তথ্য সর্বাধিক ১০০০ অক্ষর হতে পারবে।",
  },
  descent: {
    maxLength: "বংশ পরিচয় তথ্য সর্বাধিক ১০০০ অক্ষর হতে পারবে।",
  },
  economic_status: {
  ...
  economic_status_details: {
    ...
    maxLength: "আর্থিক অবস্থার বিস্তারিত সর্বাধিক ১৫০০ অক্ষর হতে পারবে না।",
  },
};
