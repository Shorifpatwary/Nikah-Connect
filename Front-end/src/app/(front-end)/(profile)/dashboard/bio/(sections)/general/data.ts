...
export const Data = {
  ...
  edit: {
    ...
    success: {
      ...
      description:
        "আপনার বায়োডাটার সাধারণ তথ্য সফলভাবে আপডেট হয়েছে। অনুগ্রহ করে প্রয়োজন অনুযায়ী অন্য তথ্য আপডেট করুন।",
      redirectUrl: Routes.profile_bio.url,
      shortToLongRedirect: Routes.profile_bio.location.edit,
    },
    error: {
...
export const VM = {
  ...
  gender: {
    required: "অনুগ্রহ করে আপনার বায়োডাটার ধরন নির্বাচন করুন।",
  },
  marital_status: {
