...
export const Data = {
  ...
  edit: {
    title: "শিক্ষা সম্পর্কিত তথ্য",
    submit: "আপডেট করুন",

    success: {
      title: "শিক্ষা সম্পর্কিত তথ্য সফলভাবে আপডেট হয়েছে",
      description:
        "আপনার শিক্ষা সম্পর্কিত তথ্য সফলভাবে আপডেট হয়েছে। প্রয়োজন অনুযায়ী অন্য তথ্য আপডেট করুন।",
      redirectUrl: Routes.profile_bio.url,
      shortToLongRedirect: Routes.profile_bio.personal_info.edit,
    },
    error: {
      title: "শিক্ষা সম্পর্কিত তথ্য আপডেট করা সম্ভব হয়নি",
      description:
        "আপনার শিক্ষা সম্পর্কিত তথ্য আপডেট করা সম্ভব হয়নি। অনুগ্রহ করে আবার চেষ্টা করুন।",
      tryAgainDescription: "দয়া করে সংশোধনী মেনে পুনরায় চেষ্টা করুন।",
      422: {
        title: "শিক্ষা সম্পর্কিত তথ্য সঠিকভাবে পূরণ করা হয়নি",
        description:
          "আপনার শিক্ষা সম্পর্কিত তথ্য সঠিকভাবে আপডেট করা সম্ভব হয়নি। দয়া করে যাচাই করুন এবং পুনরায় চেষ্টা করুন।",
      },
    },
  },
  inputs: {
    ...
    current_study: {
      ...
      placeholder: "বর্তমান অধ্যয়নের বিষয় উল্লেখ করুন",
      suggestions: [
...
export const VM = {
  ...
  highest_qualification: {
    ...
    maxLength: "সর্বোচ্চ শিক্ষাগত যোগ্যতা সর্বাধিক ১০০০ অক্ষর হতে পারবে।",
  },
  current_study: {
    maxLength: "বর্তমান অধ্যয়ন সর্বাধিক ১০০০ অক্ষর হতে পারবে।",
  },
  previous_exams: {
    required:
    ...
    maxLength: "পূর্ববর্তী পরীক্ষা তথ্য সর্বাধিক ২৫০০ অক্ষর হতে পারবে।",
  },
  other_qualifications: {
    maxLength: "অন্যান্য যোগ্যতা সর্বাধিক ২৫০০ অক্ষর হতে পারবে।",
  },
};
