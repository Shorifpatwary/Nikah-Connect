"use client";
import { createBioPersonalDetails } from "@/app/(front-end)/(profile)/dashboard/bio/(sections)/personal-details/create/createAction";
import {
  Data,
  VM,
...
export type PersonalDetailsCreateSchemaType = Output<typeof Schema>;

const BioPersonalDetailsCreateForm = () => {
  ...
  const {
    ...
    setError,
    reset,
  } = useForm<PersonalDetailsCreateSchemaType>({
    resolver: valibotResolver(Schema),
  });

  const onSubmit: SubmitHandler<
    PersonalDetailsCreateSchemaType
  > = async formData => {
    await createBioPersonalDetails<PersonalDetailsCreateSchemaType>({
      data: formData,
      setError,
      reset,
      toast,
...
export default BioPersonalDetailsCreateForm;
