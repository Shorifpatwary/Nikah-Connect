...
export const Data = {
  create: {
    ...
    success: {
      title: "ধার্মিকতা সম্পর্কিত তথ্য সফলভাবে সংরক্ষিত হয়েছে!",
      description:
        "আপনার ধার্মিকতা সম্পর্কিত তথ্য সফলভাবে সংরক্ষিত হয়েছে। পরবর্তী ধাপের জন্য দয়া করে প্রয়োজনীয় তথ্যগুলো পূরণ করুন।",
      redirectUrl: Routes.profile_bio.url,
    },
    error: {
      title: "ধার্মিকতা সম্পর্কিত তথ্য সংরক্ষণে সমস্যা!",
      description:
        "আপনার ধার্মিকতা সম্পর্কিত তথ্য সংরক্ষণ করা সম্ভব হয়নি। দয়া করে আবার চেষ্টা করুন। যদি সমস্যা অব্যাহত থাকে, কর্তৃপক্ষের সাথে যোগাযোগ করুন।",
      tryAgainDescription: "দয়া করে সংশোধনী মেনে পুনরায় চেষ্টা করুন।",
      403: {
        title:
          "আপনি ইতোমধ্যে এই বায়ো ডাটার ধার্মিকতা সম্পর্কিত তথ্য তৈরি করেছেন।",
        description: "অনুগ্রহ করে পূর্বের তৈরি করা বায়ো ডাটাটি সম্পাদনা করুন।",
        redirectUrl: Routes.profile_bio.religious_activities.edit,
      },
      422: {
        title: "ধার্মিকতা সম্পর্কিত তথ্যগুলো সঠিকভাবে পূরণ হয়নি।",
        description:
  ...
  edit: {
    title: "ধার্মিকতা সম্পর্কিত তথ্য",
    submit: "আপডেট করুন",

    success: {
      title: "ধার্মিকতা সম্পর্কিত তথ্য সফলভাবে আপডেট হয়েছে",
      description:
        "আপনার ধার্মিকতা সম্পর্কিত তথ্য সফলভাবে আপডেট হয়েছে। প্রয়োজন অনুযায়ী অন্য তথ্য আপডেট করুন।",
      redirectUrl: Routes.profile_bio.url,
      shortToLongRedirect: Routes.profile_bio.marital_info.edit,
    },
    error: {
      title: "ধার্মিকতা সম্পর্কিত তথ্য আপডেট করা সম্ভব হয়নি",
      description:
        "আপনার ধার্মিকতা সম্পর্কিত তথ্য আপডেট করা সম্ভব হয়নি। অনুগ্রহ করে আবার চেষ্টা করুন।",
      tryAgainDescription: "দয়া করে সংশোধনী মেনে পুনরায় চেষ্টা করুন।",
      422: {
        title: "ধার্মিকতা সম্পর্কিত তথ্য সঠিকভাবে পূর্ণ করা হয়নি",
        description:
          "আপনার ধার্মিকতা সম্পর্কিত তথ্য সঠিকভাবে আপডেট করা সম্ভব হয়নি। দয়া করে যাচাই করুন এবং পুনরায় চেষ্টা করুন।",
      },
    },
  },
