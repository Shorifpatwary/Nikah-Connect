...
export const Data = {
  ...
  inputs: {
    ...
    family_religious_environment: {
      ...
      suggestions: [
        "পরিবারে ধর্মের প্রভাব সম্পর্কে লিখুন।",
        "পরিবারের সদস্যরা নামাজ পড়েন কিনা, পর্দা পালন করেন কিনা, এবং মাহরাম/নন-মাহরাম নিয়ম মানেন কিনা।",
        "পরিবারের সদস্যরা কুরআন তিলাওয়াত করেন বা ইসলামী শিক্ষা গ্রহণ করেন কিনা।",
      ],
    },
  },
  unKnownError: {
